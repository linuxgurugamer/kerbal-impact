...
namespace kerbal_impact
{
    ...
    class AsteroidDensityContract : ImpactContract
    {
        private const String titleBlurb = "#autoLOC_AsteroidDensityContract_Blurb";
        private const String descriptionBlurb = "#autoLOC_AsteroidDensityContract_Blurb";
        ...
        protected override List<PossibleContract> pickContracts(IEnumerable<CelestialBody> bodies)
        {
            ...
            foreach (Vessel asteroid in asteroids)
            {
                ...
                IEnumerable<AsteroidDensityContract> contracts = ContractSystem.Instance.GetCurrentContracts<AsteroidDensityContract>()
                ...
                contracts = ContractSystem.Instance.GetCurrentContracts<AsteroidDensityContract>()
